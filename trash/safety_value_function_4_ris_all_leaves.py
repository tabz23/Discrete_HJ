"""
Safety Value Functions with Formal Guarantees - OPTIMIZED PARALLEL Implementation
==================================================================================
...
Usage:
    python safety_value_function_4.py --algorithm 2 --resolution 1 --iterations 100 --plot-failure --initial-resolution 1 --gamma 0.05 --dt 0.05
"""
...
class SafetyValueIterator:
    """Implements Algorithm 1 with optimized parallelization."""
...
class AdaptiveRefinement:
    """Algorithm 2/3 with optimized parallelization."""
...
def run_algorithm_1(args):
    ...
    print("="*70)
    print("ALGORITHM 1: Discretization Routine (OPTIMIZED PARALLEL)")
    print("="*70)
...
def run_algorithm_2(args):
    """Runs Algorithm 2/3: Adaptive refinement (optimized)."""
    print("="*70)
    print("ALGORITHM 2/3: Adaptive Refinement (OPTIMIZED PARALLEL)")
    print("="*70)
    ...
    rname = type(reachability).__name__
    output_dir = f"./results_adaptive_optimized/{rname}"
    param_suffix = (
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Safety Value Function Computation - OPTIMIZED PARALLEL",
    ...
    print(f"\n{'='*70}")
    print("OPTIMIZED PARALLEL SAFETY VALUE FUNCTION")
    print(f"{'='*70}")
